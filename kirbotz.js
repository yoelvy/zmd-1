...
kirbotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Created By NoverBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By NoverBotz`, global.thumb, btn)
}
break
case 'userkirbotz':{
